...
namespace EopSpw 
{
	...
	* --------------------------------------------------------------------------- */
	...
	)
	{
...
#ifdef _MSC_VER
		fopen_s(&infile, (EopLoc+"nut80.dat").c_str(), "r");
#else
		...
		*    iau06n.dat  - file for nutation coefficients
		*    iau06pl.dat notused - file for planetary nutation coefficients
	...
	)
	{
		...
		//        iau06arr.axs0[k, 0] = Convert.ToDouble(linedata[2]) * convrtu;  // rad
		//        iau06arr.axs0[k, 1] = Convert.ToDouble(linedata[3]) * convrtu;  // rad
		//                                                                        // integers
		//        for (j = 0; j < 13; j++)
		//            iau06arr.a0xi[k, j] = Convert.ToInt32(linedata[j + 4]);
		//        k = k + 1;
		//        ktr = ktr + 1;
		//    }
		//}
			...
			// iau06x.txt in IERS
#ifdef _MSC_VER
		fopen_s(&infile, (EopLoc + "iau06xtab5.2.a.dat").c_str(), "r");
#else
		infile = fopen(EopLoc, "r");
#endif
		// read header lines
		...
		for (i = 0; i < 1600; i++)
		{
			...
			ret = fscanf_s(infile, "%d %lf %lf %d %d %d %d %d %d %d %d %d %d %d %d %d %d \n ",
				&tmpint, &iau06arr.axs0[i][0], &iau06arr.axs0[i][1],
				&iau06arr.a0xi[i][0], &iau06arr.a0xi[i][1], &iau06arr.a0xi[i][2], &iau06arr.a0xi[i][3],
				&iau06arr.a0xi[i][4], &iau06arr.a0xi[i][5], &iau06arr.a0xi[i][6], &iau06arr.a0xi[i][7],
				&iau06arr.a0xi[i][8], &iau06arr.a0xi[i][9], &iau06arr.a0xi[i][10], &iau06arr.a0xi[i][11],
				&iau06arr.a0xi[i][12], &iau06arr.a0xi[i][13]);
#else
			...
			for (j = 0; j <= 1; j++)
				iau06arr.axs0[i][j] = iau06arr.axs0[i][j] * convrtu;   // rad
		}

		// tab5.2b.txt in IERS
#ifdef _MSC_VER
		fopen_s(&infile, (EopLoc + "iau06ytab5.2.b.dat").c_str(), "r");
#else
		infile = fopen(EopLoc, "r");
#endif
		// read header lines
		...
		for (i = 0; i < 1275; i++)
		{
#ifdef _MSC_VER
			ret = fscanf_s(infile, "%d %lf %lf %d %d %d %d %d %d %d %d %d %d %d %d %d %d \n ",
				&tmpint, &iau06arr.ays0[i][0], &iau06arr.ays0[i][1],
				&iau06arr.a0yi[i][0], &iau06arr.a0yi[i][1], &iau06arr.a0yi[i][2], &iau06arr.a0yi[i][3],
				&iau06arr.a0yi[i][4], &iau06arr.a0yi[i][5], &iau06arr.a0yi[i][6], &iau06arr.a0yi[i][7],
				&iau06arr.a0yi[i][8], &iau06arr.a0yi[i][9], &iau06arr.a0yi[i][10], &iau06arr.a0yi[i][11],
				&iau06arr.a0yi[i][12], &iau06arr.a0yi[i][13]);
#else
			ret = fscanf(infile, "%d %lf %lf %d %d %d %d %d %d %d %d %d %d %d %d %d %d \n ",
				&tmpint, &iau06arr.ays0[i][0], &iau06arr.ays0[i][1],
				&iau06arr.a0yi[i][0], &iau06arr.a0yi[i][1], &iau06arr.a0yi[i][2], &iau06arr.a0yi[i][3],
			...
			for (j = 0; j <= 1; j++)
				iau06arr.ays0[i][j] = iau06arr.ays0[i][j] * convrtu;   // rad
		}

		// tab5.2d.txt in IERS
#ifdef _MSC_VER
		fopen_s(&infile, (EopLoc + "iau06stab5.2.d.dat").c_str(), "r");
#else
		infile = fopen(EopLoc, "r");
#endif
		// read header lines
		...
		for (i = 0; i < 66; i++)
		{
#ifdef _MSC_VER
			ret = fscanf_s(infile, "%d %lf %lf %d %d %d %d %d %d %d %d %d %d %d %d %d %d \n ",
				&tmpint, &iau06arr.ass0[i][0], &iau06arr.ass0[i][1],
				&iau06arr.a0si[i][0], &iau06arr.a0si[i][1], &iau06arr.a0si[i][2], &iau06arr.a0si[i][3],
				&iau06arr.a0si[i][4], &iau06arr.a0si[i][5], &iau06arr.a0si[i][6], &iau06arr.a0si[i][7],
				&iau06arr.a0si[i][8], &iau06arr.a0si[i][9], &iau06arr.a0si[i][10], &iau06arr.a0si[i][11],
				&iau06arr.a0si[i][12], &iau06arr.a0si[i][13]);
#else
			ret = fscanf(infile, "%d %lf %lf %d %d %d %d %d %d %d %d %d %d %d %d %d %d \n ",
				&tmpint, &iau06arr.ass0[i][0], &iau06arr.ass0[i][1],
				&iau06arr.a0si[i][0], &iau06arr.a0si[i][1], &iau06arr.a0si[i][2], &iau06arr.a0si[i][3],
			...
			for (j = 0; j <= 1; j++)
				iau06arr.ass0[i][j] = iau06arr.ass0[i][j] * convrtu;   // rad
		}

		//     // nutation values old approach iau2000a
#ifdef _MSC_VER
		fopen_s(&infile, (EopLoc + "iau06ansofa.dat").c_str(), "r");
#else
		infile = fopen(EopLoc, "r");
#endif
		// read header lines
		...
		for (i = 0; i < 678; i++)
		{
			...
			ret = fscanf_s(infile, "%d %d %d %d %d %lf %lf %lf %lf %lf %lf %lf %lf %lf \n",
				&iau06arr.appni[i][0], &iau06arr.appni[i][1], &iau06arr.appni[i][2], &iau06arr.appni[i][3], &iau06arr.appni[i][4],
				&tmpdbl,
				&iau06arr.appn[i][0], &iau06arr.appn[i][1], &iau06arr.appn[i][2], &iau06arr.appn[i][3],
				&iau06arr.appn[i][4], &iau06arr.appn[i][5], &iau06arr.appn[i][6], &iau06arr.appn[i][7]);
#else
			...
			for (j = 0; j < 8; j++)
				iau06arr.appn[i][j] = iau06arr.appn[i][j] * convrtm;   // rad
		}

		//     // planetary nutation values
#ifdef _MSC_VER
		fopen_s(&infile, (EopLoc + "iau06anplsofa.dat").c_str(), "r");
#else
		infile = fopen(EopLoc, "r");
#endif
		// read header lines
		...
		for (i = 0; i < 687; i++)
		{
			...
			ret = fscanf_s(infile, "%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %lf %lf %lf %lf %lf %lf \n",
				&tmpint,
				&iau06arr.aplni[i][0], &iau06arr.aplni[i][1], &iau06arr.aplni[i][2], &iau06arr.aplni[i][3], &iau06arr.aplni[i][4],
				&iau06arr.aplni[i][5], &iau06arr.aplni[i][6], &iau06arr.aplni[i][7], &iau06arr.aplni[i][8], &iau06arr.aplni[i][9],
				&iau06arr.aplni[i][10], &iau06arr.aplni[i][11], &iau06arr.aplni[i][12], &iau06arr.aplni[i][13],
				&tmpdbl, &iau06arr.apln[i][0], &iau06arr.apln[i][1],
				&iau06arr.apln[i][2], &iau06arr.apln[i][3], &iau06arr.apln[i][4]);
#else
...
#endif
			for (j = 0; j < 5; j++)
				iau06arr.apln[i][j] = iau06arr.apln[i][j] * convrtm;   // rad
		}
...
#ifdef _MSC_VER
		fopen_s(&infile, (EopLoc + "iau06nlontab5.3.a.dat").c_str(), "r");
#else
		infile = fopen(EopLoc, "r");
#endif
		// read header lines
		...
		for (i = 0; i < 1358; i++)
		{
			...
			ret = fscanf_s(infile, "%d %lf %lf %d %d %d %d %d %d %d %d %d %d %d %d %d %d \n",
				&tmpint,
				&iau06arr.apn[i][0], &iau06arr.apn[i][1],
				&iau06arr.apni[i][0], &iau06arr.apni[i][1], &iau06arr.apni[i][2], &iau06arr.apni[i][3], &iau06arr.apni[i][4],
				&iau06arr.apni[i][5], &iau06arr.apni[i][6], &iau06arr.apni[i][7], &iau06arr.apni[i][8], &iau06arr.apni[i][9],
				&iau06arr.apni[i][10], &iau06arr.apni[i][11], &iau06arr.apni[i][12], &iau06arr.apni[i][13]);
#else
			ret = fscanf(infile, "%d %lf %lf %d %d %d %d %d %d %d %d %d %d %d %d %d %d \n",
				&tmpint,
				&iau06arr.apn[i][0], &iau06arr.apn[i][1],
...
#endif
			for (j = 0; j < 1; j++)
				iau06arr.apn[i][j] = iau06arr.apn[i][j] * convrtu;   // rad
		}
	...
	// nutation in obliquity
#ifdef _MSC_VER
		fopen_s(&infile, (EopLoc + "iau06nobltab5.3.b.dat").c_str(), "r");
#else
		infile = fopen(EopLoc, "r");
#endif
		// read header lines
		...
		for (i = 0; i < 1056; i++)
		{
			...
			ret = fscanf_s(infile, "%d %lf %lf %d %d %d %d %d %d %d %d %d %d %d %d %d %d \n",
				&tmpint,
				&iau06arr.ape[i][0], &iau06arr.ape[i][1],
				&iau06arr.apei[i][0], &iau06arr.apei[i][1], &iau06arr.apei[i][2], &iau06arr.apei[i][3], &iau06arr.apei[i][4],
				&iau06arr.apei[i][5], &iau06arr.apei[i][6], &iau06arr.apei[i][7], &iau06arr.apei[i][8], &iau06arr.apei[i][9],
				&iau06arr.apei[i][10], &iau06arr.apei[i][11], &iau06arr.apei[i][12], &iau06arr.apei[i][13]);
#else
			ret = fscanf(infile, "%d %lf %lf %d %d %d %d %d %d %d %d %d %d %d %d %d %d \n",
				&tmpint,
				&iau06arr.ape[i][0], &iau06arr.ape[i][1],
...
#endif
			for (j = 0; j < 1; j++)
				iau06arr.ape[i][j] = iau06arr.ape[i][j] * convrtu;   // rad
		}


		// tab5.2e.txt in IERS
		// gmst values
		// note - these are very similar to the first 34 elements of iau06s.dat,
		// but they are not the same.
#ifdef _MSC_VER
		fopen_s(&infile, (EopLoc + "iau06gsttab5.2.e.dat").c_str(), "r");
#else
		infile = fopen(EopLoc, "r");
#endif
		// read header lines
		...
		for (i = 0; i < 34; i++)
		{
			...
			ret = fscanf_s(infile, "%d %lf %lf %d %d %d %d %d %d %d %d %d %d %d %d %d %d \n",
				&tmpint,
				&iau06arr.agst[i][0], &iau06arr.agst[i][1],
				&iau06arr.agsti[i][0], &iau06arr.agsti[i][1], &iau06arr.agsti[i][2], &iau06arr.agsti[i][3], &iau06arr.agsti[i][4],
				&iau06arr.agsti[i][5], &iau06arr.agsti[i][6], &iau06arr.agsti[i][7], &iau06arr.agsti[i][8], &iau06arr.agsti[i][9],
				&iau06arr.agsti[i][10], &iau06arr.agsti[i][11], &iau06arr.agsti[i][12], &iau06arr.agsti[i][13]);
#else
			ret = fscanf(infile, "%d %lf %lf %d %d %d %d %d %d %d %d %d %d %d %d %d %d \n",
				&tmpint,
				&iau06arr.agst[i][0], &iau06arr.agst[i][1],
...
#endif
			for (j = 0; j <= 1; j++)
				iau06arr.agst[i][j] = iau06arr.agst[i][j] * convrtu;   // rad
		}
	...
	*  -------------------------------------------------------------------------- */
		...
		)
	{
		...
		// ---- open files
#ifdef _MSC_VER
		fopen_s(&infile, infilename.c_str(), "r");
#else
