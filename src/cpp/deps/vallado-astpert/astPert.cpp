...
//			r3mag = MathTimeLib::mag(r3);
		...
		)
	{
		...
		double reci[3], veci[3], aeci[3], aecef[3], fArgs[14];
...
//start_s = clock();
			...
			double psia, wa, epsa, chia, trueeps, meaneps, omega, omegaearth[3];
			...
			AstroLib::nutation(ttt, ddpsi, ddeps, iau80rec, e80, fArgs, deltapsi, deltaeps, trueeps, meaneps, nut);
			AstroLib::sidereal(jdut1, deltapsi, meaneps, fArgs, lod, 2, e80, st, stdot);
			AstroLib::polarm(xp, yp, ttt, e80, pm);

			// ---- perform transformations
			omegaearth[0] = 0.0;
			omegaearth[1] = 0.0;
			omegaearth[2] = 7.29211514670698e-05 * (1.0 - lod * dayconv);
